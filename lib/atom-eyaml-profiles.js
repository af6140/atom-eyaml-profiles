...
export default {
  ...
  activate(state) {
    ...
    this.atomEyamlProfilesActiveProfileView = new AtomEyamlProfilesActiveProfileView(
      ...
      state.atomEyamlProfilesActiveProfileView);
  ...
  deactivate() {
    ...
    this.atomEyamlProfilesActiveProfileView.destroy();
  ...
  toggle() {
    console.log('AtomEyamlProfiles was activated!');
    atom.notifications.addSuccess('atom-eyaml-profiles plugin enabled');
  },

  setprofile(active) {
    console.log('Set active profile');
    let newProfile = this.atomEyamlProfilesActiveProfileView.getUserInput();
