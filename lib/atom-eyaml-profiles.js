...
export default {
  ...
  activate(state) {
    ...
    if(this.statusBar!=null){
      this.statusBarTile = this.statusBar.addLeftTile(item: this.statusBarView.getElement(), priority: 100)
    }
  ...
  consumeStatusBar (statusBar) {
    ...
    //this.statusBarTile = statusBar.addLeftTile(item: this.statusBarTile.getElement(), priority: 100)
  }
};
